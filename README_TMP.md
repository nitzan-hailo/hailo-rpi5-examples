...
# Hailo Raspberry Pi 5 Example - Dunes
...
The application description-chart can be found [here](https://hailotech.atlassian.net/wiki/spaces/DH2/pages/1948157669/App+Pipeline).
